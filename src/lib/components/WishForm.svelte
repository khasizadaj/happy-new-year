...
<section class="section section-form">
	<div class="wrapper form-wrapper">
		{#if languageValue === 'en'}
			<p>
				It's been few years already that I've been congratulating some of you in this form. I'm both
				writing code and congratulations, two birds with one stone. In order to see my wishes, add
				your name and click on "See message" button.
			</p>
			<p>
			...
			<form id="name-form">
				...
				<button
					type="submit"
					on:click|preventDefault={(e) => handleForm(e)}
					class="button button-wide">See JAXA's message</button
				>
				<button
					type="submit"
		...
		{:else}
			<p class="mb-4">
				Artıq bir neçə ildir ki, bu formada təbrik edirəm bəzilərini. Həm kod yazıram, həm də təbrik
				edirəm, bir daşla iki quş.
			</p>
			<p>
			...
			<form id="name-form">
				...
				<button
					type="submit"
					on:click|preventDefault={(e) => handleForm(e)}
					class="button button-wide">Təbriki gör</button
				>
				<button
					type="submit"
					on:click|preventDefault={(e) => handleForm(e, true)}
					class="button button-ghost anonymous link">> Adımı yazmaq istəmirəm</button
				>
			</form>
		{/if}
	</div>
